...
| ![Missing Data Heatmap](images/life_expectancy_heatmap.png) | ![Histogram Example](images/life_expectancy_histogram.png) |
|:--------------------------------------------------------:|:---------------------------------------------------------:|
...
# University Admission Selection Model

This project focuses on predicting university admission chances using a machine learning model based on academic and demographic data. The implementation involves data preprocessing, visualization, and regression model building. Below is a comprehensive description of the methodologies, tools, and technologies used in this project.
...
- **Matplotlib**: Used for visualizing data distributions and results.
- **Seaborn**:
  - Generated pair plots to explore relationships between features.
  - Created scatter plots to visualize feature relationships and university ratings.
...
- Trained the XGBoost regressor:
  ```python
  from xgboost import XGBRegressor
  model = XGBRegressor(objective='reg:squarederror', learning_rate=0.1, max_depth=2, n_estimators=100)
  model.fit(X_train, y_train)
  ```
- Evaluated the model:
  ```python
...
| ![Pair Plot Example](images/admission_pairplot.png) | ![Histogram Example](images/admission_histogram.png) |
|:--------------------------------------------------------:|:---------------------------------------------------------:|
| **Pair Plot Heatmap**                                 | **Histogram Example**                                  |

| ![Model Performance Metrics](images/admission_scores.png) | ![Scatter Plot Example](images/admission_scatterplot.png) |
|:-----------------------------------------------------------:|:---------------------------------------------------------:|
| **Model Performance Metrics**                              | **Scatter Plot Example**                                  |
...
This project demonstrates the application of machine learning in predicting university admission chances, providing valuable insights for academic planning.
